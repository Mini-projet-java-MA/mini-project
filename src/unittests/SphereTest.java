...
public class SphereTest {
    ...
    public void get_center() {
        ...
        try {
            ...
            double radius = 2;
            Sphere mySphere = new Sphere(primitives.Color.BLACK, radius, centerPoint);
    ...
    public void getNormal() {
        ...
        try {
            Sphere sp = new Sphere(primitives.Color.BLACK, 1.0, new Point3D(0, 0, 1));
    ...
    public void findIntersections() {
        ...
        Sphere sphere =
                new Sphere(primitives.Color.BLACK, 1, new Point3D(0, 2, -4));
        ...
        sphere = new Sphere(primitives.Color.BLACK, 2, new Point3D(0, 0, 0));
        ...
        sphere = new Sphere(primitives.Color.BLACK, 5, new Point3D(0, -1, -1));
        intersectionsList = sphere.findIntersections(ray);
        ...
        ray = new Ray(new Point3D(0, 0, 0), new Vector(0, 0, -1));
        sphere = new Sphere(primitives.Color.BLACK, 2, new Point3D(0, 1, 4));
        intersectionsList = sphere.findIntersections(ray);
        assertNull("must be empty", intersectionsList);
        ...
        ray = new Ray(new Point3D(0, 0, 0), new Vector(0, 0, -1));
        sphere = new Sphere(primitives.Color.BLACK, 5, new Point3D(0, 0, 0));
        intersectionsList = sphere.findIntersections(ray);
        assertNotNull("must be not empty", intersectionsList);
        assertEquals("must be equal to one", 1, intersectionsList.size());
        ...
        sphere = new Sphere(primitives.Color.BLACK, 2, new Point3D(0, 0, 1));
        intersectionsList = sphere.findIntersections(ray);
        assertNull("must be empty",intersectionsList);
        /*assertNotNull("must be not empty", intersectionsList);
        assertEquals("must be equal to one", 1, intersectionsList.size());
        ...
        sphere = new Sphere(primitives.Color.BLACK, 2, new Point3D(0, 0, 6));
        intersectionsList = sphere.findIntersections(ray);
        assertNotNull("must be not empty", intersectionsList);
        assertEquals("must be equal to one", 1, intersectionsList.size());
        ...
        ray = new Ray(new Point3D(0, 0, 0), new Vector(0, 0, -1));
        sphere = new Sphere(primitives.Color.BLACK, 5, new Point3D(0, 0, 6));
        intersectionsList = sphere.findIntersections(ray);
        assertNull("must be empty", intersectionsList);
        ...
        ray = new Ray(new Point3D(0, 0, 0), new Vector(0, 0, -1));
        sphere = new Sphere(primitives.Color.BLACK, 1, new Point3D(0, 2, 0));
        intersectionsList = sphere.findIntersections(ray);
        assertNull("must be empty", intersectionsList);
        ...
        ray = new Ray(new Point3D(0, 0, 0), new Vector(0, 0, -1));
        sphere = new Sphere(primitives.Color.BLACK, 1, new Point3D(0, 1, -1));
        intersectionsList = sphere.findIntersections(ray);
        assertNull("must be empty", intersectionsList);

        //TC17 ray is on the tangent line- ray starts on intersection: 1 intersection
        ray = new Ray(new Point3D(0, 0, 0), new Vector(0, 0, -1));
        sphere = new Sphere(primitives.Color.BLACK, 1, new Point3D(0, 1, 0));
        intersectionsList = sphere.findIntersections(ray);
        assertNull("must be empty", intersectionsList);
