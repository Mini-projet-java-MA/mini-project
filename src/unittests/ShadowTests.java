...
public class ShadowTests {
	 ...
	 */
	@Test
	public void SphereTriangleInitialadvece() {
		Scene scene = new Scene("Test scene");
		scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
		scene.setDistance(1000);
		scene.setBackground(Color.BLACK);
		...
		ImageWriter imageWriter = new ImageWriter("sphereTriangleInitialAdvace", 200, 200, 400, 400);
		Render render = new Render(imageWriter, scene);
	...
	public void SphereTriangleSpot1() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), //
				new Point3D(-90, 90, -140), new Vector(1, -1, 3), 1, 1E-5, 1.5E-7));
	...
	public void SphereTriangleSpot2() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), //
				new Point3D(-80, 80, -120), new Vector(1, -1, 3), 1, 1E-5, 1.5E-7));
