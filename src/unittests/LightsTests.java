...
public class LightsTests {
    ...
    public void trianglesSpotImproved() {
        Scene scene = new Scene("Test scene");
        scene.setCamera(
                new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
        scene.setDistance(1000);
        scene.setBackground(Color.BLACK);
        scene.setAmbientLight(new AmbientLight(new Color(java.awt.Color.WHITE), 0.15));
        ...
        scene.addGeometries(
                new Triangle(
                        ...
                        new Point3D(-150, 150, 150), new Point3D(150, 150, 150), new Point3D(75, -75, 150)),
                new Triangle(
                        Color.BLACK, new Material(0.5, 0.5, 300), new Point3D(-150, 150, 150),
    ...
    public void SphereSpotImproved() {
        ...
        scene.setCamera(
                new Camera(
                        new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));scene.setDistance(1000);
        scene.setBackground(Color.BLACK);
        scene.setAmbientLight(new AmbientLight(new Color(java.awt.Color.WHITE), 0.15));
        ...
        ImageWriter imageWriter = new ImageWriter("SphereSpotImproved", 200, 200, 500, 500);
        Render render = new Render(imageWriter, scene);
